    ...
    <>
      {isOpen && (
        ...
        >
          <div
            ref={refElem}
            className="w-[calc(100vw-3rem)] sm:w-[600px] max-h-[calc(100vh-3rem)] overflow-y-auto fixed top-1/2 left-1/2 p-5 rounded-lg backdrop-blur-0 -translate-x-1/2 -translate-y-1/2 bg-secondary-0 shadow-xl transition-all duration-500"
          >
